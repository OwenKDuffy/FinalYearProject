...
def main(date):
    ...
    df_multi_journeys = pd.read_csv(('./ProducedData/Multistops/Normalised/' + str(date) + '.csv'),dtype = {'Stop1': 'int32', 'Stop2': 'int32', 'Stop3': 'int32'})
    df_journeys = pd.read_csv(('./ProducedData/Pairstops/Normalised/' + str(date) + '.csv'),dtype = {'Stop1': 'int32', 'Stop2': 'int32'})
